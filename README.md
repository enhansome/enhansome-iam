...
This curated [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,059 | 🐛 105 | 📅 2026-08-18 list expose all the technologies, protocols and jargon of the domain in a comprehensive and actionable manner.
...
* [Cartography](https://github.com/lyft/cartography) ⭐ 4,015 | 🐛 100 | 🌐 Python | 📅 2026-08-20 - 🆓 A Neo4J-based tool to map out dependencies and relationships between services and resources. Supports AWS, GCP, GSuite, Okta and GitHub.
...
* [Kratos](https://github.com/ory/kratos) ⭐ 13,834 | 🐛 222 | 🌐 Go | 📅 2026-07-29 - 💸 User login, user registration, 2FA and profile management.
...
* [Papers we love: Cryptography](https://github.com/papers-we-love/papers-we-love/blob/master/cryptography/README.md) ⭐ 108,868 | 🐛 3 | 🌐 Shell | 📅 2026-07-01 - Foundational papers of cryptography.
...
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,965 | 🐛 148 | 🌐 Go | 📅 2026-08-20 - 💸 An identity-aware proxy that enables secure access to internal applications.

* [oathkeeper](https://github.com/ory/oathkeeper) ⭐ 3,593 | 🐛 107 | 🌐 Go | 📅 2026-07-27 - 💸 Identity & Access Proxy and Access Control Decision API that authenticates, authorizes, and mutates incoming HTTP requests. Inspired by the BeyondCorp / Zero Trust white paper.

* [heimdall](https://github.com/dadrus/heimdall) ⭐ 254 | 🐛 58 | 🌐 Go | 📅 2026-08-20 - 🆓 A cloud-native, identity-aware proxy and policy enforcement point that orchestrates authentication and authorization systems via versatile rules, supporting protocol-agnostic identity propagation.
...
* [SPIFFE/SPIRE](https://github.com/spiffe/spire) ⭐ 2,493 | 🐛 138 | 🌐 Go | 📅 2026-08-20 - 🆓 A CNCF framework issuing short-lived, cryptographically-verifiable identities (SVIDs) to workloads across heterogeneous environments.
...
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,791 | 🐛 132 | 🌐 JavaScript | 📅 2026-08-18 - 🆓 A collection of password rules, change URLs and quirks by sites.
...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,635 | 🐛 132 | 🌐 Go | 📅 2026-08-20 - 🆓 Open-source authentication and authorization server providing two-factor authentication and single sign-on (SSO) for your applications via a web portal.

* [Kanidm](https://github.com/kanidm/kanidm) ⭐ 5,256 | 🐛 263 | 🌐 Rust | 📅 2026-08-20 - 🆓 Simple, secure and fast identity management platform.
...
* [YubiKey Guide](https://github.com/drduh/YubiKey-Guide) ⭐ 12,446 | 🐛 10 | 🌐 HTML | 📅 2026-08-19 - Guide to using YubiKey as a SmartCard for storing GPG encryption, signing and authentication keys, which can also be used for SSH. Many of the principles in this document are applicable to other smart card devices.
...
* [JA4+](https://github.com/FoxIO-LLC/ja4) ⭐ 2,051 | 🐛 27 | 🌐 Rust | 📅 2026-08-14 - 💸 A suite of network fingerprinting methods to facilitate threat-hunting and analysis.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,546 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - 💸 An authorization endpoint to write context-aware access control policies.

* [Athenz](https://github.com/yahoo/athenz) ⭐ 1,000 | 🐛 46 | 🌐 Java | 📅 2026-08-19 - 🆓 Set of services and libraries supporting service authentication and role-based authorization for provisioning and configuration.

* [FerrisKey](https://github.com/ferriskey/ferriskey) ⭐ 682 | 🐛 80 | 🌐 Rust | 📅 2026-08-20 - 🆓 Self-hosted, open-source, RBAC system written in Rust.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,331 | 🐛 42 | 🌐 Go | 📅 2026-08-20 - 🆓 Open-source access control library for Golang projects.

* [Open Policy Agent](https://github.com/open-policy-agent/opa) ⭐ 12,123 | 🐛 338 | 🌐 Go | 📅 2026-08-20 - 🆓 An open-source general-purpose decision engine to create and enforce ABAC policies.

* [Keto](https://github.com/ory/keto) ⭐ 5,388 | 🐛 73 | 🌐 Go | 📅 2026-08-18 - 💸 Policy decision point. It uses a set of access control policies, similar to AWS policies, in order to determine whether a subject is authorized to perform a certain action on a resource.
...
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,976 | 🐛 152 | 🌐 Go | 📅 2026-08-19 - 💸 An open source database system for managing security-critical application permissions inspired by Zanzibar.

* [Permify](https://github.com/Permify/permify) ⭐ 5,936 | 🐛 76 | 🌐 Go | 📅 2026-08-20 - 💸 Another open-source authorization as a service inspired by Google Zanzibar, and see [how it compares to other Zanzibar-inspired tools](https://permify.notion.site/Differentiation-Between-Zanzibar-Products-ad4732da62e64655bc82d3abe25f48b6).

* [Open Policy Administration Layer](https://github.com/permitio/opal) ⭐ 5,501 | 🐛 62 | 🌐 Python | 📅 2026-08-19 - 💸 Open Source administration layer for OPA, detecting changes to both policy and policy data in realtime and pushing live updates to OPA agents. OPAL brings open-policy up to the speed needed by live applications.

* [Topaz](https://github.com/aserto-dev/topaz) ⭐ 1,359 | 🐛 10 | 🌐 Go | 📅 2026-08-20 - 💸 An open-source project which combines the policy-as-code and decision logging of OPA with a Zanzibar-modeled directory.
...
* [Gubernator](https://github.com/gubernator-io/gubernator) ⭐ 168 | 🐛 9 | 🌐 Go | 📅 2026-07-25 - 🆓 High performance rate-limiting micro-service and library.
...
* [Keycloak](https://github.com/keycloak/keycloak) ⭐ 36,305 | 🐛 3,125 | 🌐 Java | 📅 2026-08-20 - 🆓 Open-source Identity and Access Management. Supports OIDC, OAuth 2 and SAML 2, LDAP and AD directories, password policies.

* [authentik](https://github.com/goauthentik/authentik) ⭐ 25,013 | 🐛 1,061 | 🌐 Python | 📅 2026-08-20 - 💸 Open-source Identity Provider similar to Keycloak.

* [Hydra](https://github.com/ory/hydra) ⭐ 17,484 | 🐛 93 | 🌐 Go | 📅 2026-07-29 - 💸 Open-source OIDC & OAuth2 Server Provider.

* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,795 | 🐛 1,135 | 🌐 Go | 📅 2026-08-20 - 💸 An Open-Source solution built with Go and Angular to manage all your systems, users and service accounts together with their roles and external identities. ZITADEL provides you with OIDC, OAuth 2.0, login & register flows, passwordless and MFA authentication. All this is built on top of eventsourcing in combination with CQRS to provide a great audit trail.

* [Casdoor](https://github.com/casbin/casdoor) ⭐ 14,231 | 🐛 107 | 🌐 Go | 📅 2026-08-18 - 🆓 A UI-first centralized authentication / Single-Sign-On (SSO) platform based. Supports OIDC and OAuth 2, social logins, user management, 2FA based on Email and SMS.
...
* [Awesome OpenID Connect](https://github.com/cerberauth/awesome-openid-connect) ⭐ 122 | 🐛 2 | 🌐 HTML | 📅 2026-05-30 - A curated list of providers, services, libraries, and resources for OpenID Connect.
...
* [HashiCorp Vault](https://github.com/hashicorp/vault) ⭐ 36,146 | 🐛 1,426 | 🌐 Go | 📅 2026-08-20 - 💸 Secure, store and tightly control access to tokens, passwords, certificates, encryption keys.

* [Infisical](https://github.com/Infisical/infisical) ⭐ 28,862 | 🐛 736 | 🌐 TypeScript | 📅 2026-08-20 - 💸 An alternative to HashiCorp Vault.

* [`gitleaks`](https://github.com/zricethezav/gitleaks) ⭐ 28,853 | 🐛 460 | 🌐 Go | 📅 2026-08-19 - 🆓 Audit Git repos for secrets.

* [`trufflehog`](https://github.com/trufflesecurity/trufflehog) ⭐ 27,527 | 🐛 517 | 🌐 Go | 📅 2026-08-20 - 💸 Searches through Git repositories for high entropy strings and secrets, digging deep into commit history.

* [`sops`](https://github.com/mozilla/sops) ⭐ 22,867 | 🐛 439 | 🌐 Go | 📅 2026-08-17 - 🆓 Editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, age, and PGP.
...
* [Project Oak](https://github.com/project-oak/oak) ⭐ 1,493 | 🐛 18 | 🌐 Rust | 📅 2026-08-19 - 🆓 A specification and a reference implementation for the secure transfer, storage and processing of data.
...
* [Awesome List of Billing and Payments: Fraud links](https://github.com/kdeldycke/awesome-billing#fraud) ⭐ 1,329 | 🐛 2 | 📅 2026-08-14 - Section dedicated to fraud management for billing and payment, from our sister repository.
...
* [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 89,865 | 🐛 330 | 🌐 Python | 📅 2026-08-20 - 🆓 Hunt down social media accounts by username across social networks.
...
* [Statistically Likely Usernames](https://github.com/insidetrust/statistically-likely-usernames) ⭐ 1,385 | 🐛 0 | 🌐 Python | 📅 2026-02-16 - 🆓 Wordlists for creating statistically likely usernames for use in username-enumeration, simulated password-attacks and other security testing tasks.
...
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,617 | 🐛 520 | 🌐 Java | 📅 2026-08-19 - 🆓 Open-source platform for visualizing and manipulating large graphs.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 72,953 | 🐛 12 | 🌐 PHP | 📅 2026-08-20 - 🆓 Collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.

* [Maigret](https://github.com/soxoj/maigret) ⭐ 36,904 | 🐛 21 | 🌐 Python | 📅 2026-08-20 - 🆓 “Collect a dossier on a person by username from 3000+ sites”, useful for account enumeration and unmasking fraud or abuse.

* [PhoneInfoga](https://github.com/sundowndev/PhoneInfoga) ⭐ 17,558 | 🐛 122 | 🌐 Go | 📅 2026-01-06 - 🆓 Tools to scan phone numbers using only free resources. The goal is to first gather standard information such as country, area, carrier and line type on any international phone numbers with a very good accuracy. Then search for footprints on search engines to try to find the VoIP provider or identify the owner.

* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,549 | 🐛 117 | 📅 2026-05-31 - “A concise definition of Threat Intelligence: evidence-based knowledge, including context, mechanisms, indicators, implications and actionable advice, about an existing or emerging menace or hazard to assets that can be used to inform decisions regarding the subject's response to that menace or hazard.”

* [OSINT Stuff Tool Collection](https://github.com/cipher387/osint_stuff_tool_collection) ⭐ 8,701 | 🐛 85 | 🌐 HTML | 📅 2026-05-12 - “A collection of several hundred online tools for OSINT”: domain, IP, email, username and social-network lookups useful for unmasking fraud and abuse.

* [The challenges of file formats](https://speakerdeck.com/ange/the-challenges-of-file-formats) - At one point you will let users upload files in your system. Here is a [corpus of suspicious media files](https://github.com/corkami/pocs) ⭐ 1,555 | 🐛 7 | 🌐 Assembly | 📅 2024-12-22 that can be leveraged by scammers =to bypass security or fool users.

* [SpiderFoot](https://github.com/poppopjmp/spiderfoot) ⭐ 190 | 🐛 15 | 🌐 Python | 📅 2026-07-03 - 🆓 An open source intelligence (OSINT) automation tool. It integrates with just about every data source available and uses a range of methods for data analysis, making that data easy to navigate.
...
* [Anubis](https://github.com/TecharoHQ/anubis) ⭐ 21,571 | 🐛 357 | 🌐 Go | 📅 2026-08-19 - 🆓 An open-source solution to protect upstream resources from scraper bots.

* [Awesome Captcha](https://github.com/ZYSzys/awesome-captcha) ⭐ 1,420 | 🐛 10 | 🌐 JavaScript | 📅 2026-04-17 - Reference all open-source captcha libraries, integration, alternatives and cracking tools.
...
* [`hosts`](https://github.com/StevenBlack/hosts) ⭐ 30,909 | 🐛 150 | 🌐 Python | 📅 2026-08-18 - 🆓 Consolidates reputable hosts files, and merges them into a unified hosts file with duplicates removed.

* [The Public Suffix List](https://github.com/publicsuffix/list) ⭐ 2,915 | 🐛 82 | 🌐 Go | 📅 2026-08-19 - 🆓 Mozilla's registry of public suffixes, under which Internet users can (or historically could) directly register names.
...
* [`nextdns/metadata`](https://github.com/nextdns/metadata) ⭐ 670 | 🐛 238 | 📅 2023-01-20 - 💸 Extensive collection of list for security, privacy and parental control.
...
* [`check-if-email-exists`](https://github.com/reacherhq/check-if-email-exists) ⭐ 9,472 | 🐛 88 | 🌐 Rust | 📅 2026-03-17 - 💸 Verify an email address's reachability over SMTP without sending anything, catching typos, disposable domains and role accounts at signup.
...
* [Burner email providers](https://github.com/wesbos/burner-email-providers) ⭐ 1,189 | 🐛 22 | 🌐 JavaScript | 📅 2026-07-20 - 🆓 A list of temporary email providers. And its [derivative Python module](https://github.com/martenson/disposable-email-domains) ⭐ 5,431 | 🐛 36 | 🌐 Python | 📅 2026-08-20.
...
* [List of Dirty, Naughty, Obscene, and Otherwise Bad Words](https://github.com/LDNOOBW/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words) ⭐ 3,427 | 🐛 104 | 📅 2024-08-05 - 🆓 Profanity blocklist from Shutterstock.
...
* [Paper we love: Privacy](https://github.com/papers-we-love/papers-we-love/tree/master/privacy) ⭐ 108,868 | 🐛 3 | 🌐 Shell | 📅 2026-07-01 - A collection of scientific studies of schemes providing privacy by design.
...
* [Presidio](https://github.com/microsoft/presidio) ⭐ 10,565 | 🐛 106 | 🌐 Python | 📅 2026-08-11 - 🆓 Context aware, pluggable and customizable data protection and PII data anonymization service for text and images.
...
The [header image](https://github.com/kdeldycke/awesome-iam/blob/main/assets/awesome-iam-header.jpg) ⭐ 2,258 | 🐛 4 | 📅 2026-08-14 is based on a modified [photo](https://web.archive.org/web/20230919012225/https://unsplash.com/photos/2LowviVHZ-E) by [Ben Sweet](https://web.archive.org/web/20260303063416/https://unsplash.com/@benjaminsweet).
