...
This curated [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,491 | 🐛 104 | 📅 2026-08-21 list expose all the technologies, protocols and jargon of the domain in a comprehensive and actionable manner.
...
* [Open guide to AWS Security and IAM](https://github.com/open-guides/og-aws#security-and-iam) ⭐ 36,439 | 🐛 159 | 🌐 Shell | 📅 2024-08-16

* [Cartography](https://github.com/lyft/cartography) ⭐ 4,018 | 🐛 100 | 🌐 Python | 📅 2026-08-20 - 🆓 A Neo4J-based tool to map out dependencies and relationships between services and resources. Supports AWS, GCP, GSuite, Okta and GitHub.
...
* [Kratos](https://github.com/ory/kratos) ⭐ 13,835 | 🐛 223 | 🌐 Go | 📅 2026-07-29 - 💸 User login, user registration, 2FA and profile management.
...
* [Papers we love: Cryptography](https://github.com/papers-we-love/papers-we-love/blob/master/cryptography/README.md) ⭐ 108,895 | 🐛 3 | 🌐 Shell | 📅 2026-07-01 - Foundational papers of cryptography.
...
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,969 | 🐛 148 | 🌐 Go | 📅 2026-08-21 - 💸 An identity-aware proxy that enables secure access to internal applications.

* [oathkeeper](https://github.com/ory/oathkeeper) ⭐ 3,595 | 🐛 108 | 🌐 Go | 📅 2026-07-27 - 💸 Identity & Access Proxy and Access Control Decision API that authenticates, authorizes, and mutates incoming HTTP requests. Inspired by the BeyondCorp / Zero Trust white paper.
...
* [SPIFFE/SPIRE](https://github.com/spiffe/spire) ⭐ 2,494 | 🐛 136 | 🌐 Go | 📅 2026-08-21 - 🆓 A CNCF framework issuing short-lived, cryptographically-verifiable identities (SVIDs) to workloads across heterogeneous environments.

* [NanoMDM](https://github.com/micromdm/nanomdm) ⭐ 635 | 🐛 16 | 🌐 Go | 📅 2026-08-20 - 🆓 Minimalist Apple MDM server and library to enroll and manage the identity of Apple devices, inspired by MicroMDM.
...
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,791 | 🐛 133 | 🌐 JavaScript | 📅 2026-08-21 - 🆓 A collection of password rules, change URLs and quirks by sites.
...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,642 | 🐛 118 | 🌐 Go | 📅 2026-08-21 - 🆓 Open-source authentication and authorization server providing two-factor authentication and single sign-on (SSO) for your applications via a web portal.

* [Kanidm](https://github.com/kanidm/kanidm) ⭐ 5,264 | 🐛 265 | 🌐 Rust | 📅 2026-08-20 - 🆓 Simple, secure and fast identity management platform.
...
* [CFSSL](https://github.com/cloudflare/cfssl) ⭐ 9,462 | 🐛 336 | 🌐 Go | 📅 2026-04-24 - 🆓 A swiss army knife for PKI/TLS by CloudFlare. Command line tool and an HTTP API server for signing, verifying, and bundling TLS certificates.

* [JA4+](https://github.com/FoxIO-LLC/ja4) ⭐ 2,053 | 🐛 27 | 🌐 Rust | 📅 2026-08-14 - 💸 A suite of network fingerprinting methods to facilitate threat-hunting and analysis.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,547 | 🐛 57 | 🌐 Go | 📅 2026-08-18 - 💸 An authorization endpoint to write context-aware access control policies.

* [Athenz](https://github.com/yahoo/athenz) ⭐ 1,002 | 🐛 49 | 🌐 Java | 📅 2026-08-20 - 🆓 Set of services and libraries supporting service authentication and role-based authorization for provisioning and configuration.

* [FerrisKey](https://github.com/ferriskey/ferriskey) ⭐ 684 | 🐛 76 | 🌐 Rust | 📅 2026-08-20 - 🆓 Self-hosted, open-source, RBAC system written in Rust.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,333 | 🐛 38 | 🌐 Go | 📅 2026-08-21 - 🆓 Open-source access control library for Golang projects.

* [Open Policy Agent](https://github.com/open-policy-agent/opa) ⭐ 12,130 | 🐛 336 | 🌐 Go | 📅 2026-08-21 - 🆓 An open-source general-purpose decision engine to create and enforce ABAC policies.

* [Keto](https://github.com/ory/keto) ⭐ 5,388 | 🐛 73 | 🌐 Go | 📅 2026-08-21 - 💸 Policy decision point. It uses a set of access control policies, similar to AWS policies, in order to determine whether a subject is authorized to perform a certain action on a resource.
...
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,978 | 🐛 149 | 🌐 Go | 📅 2026-08-21 - 💸 An open source database system for managing security-critical application permissions inspired by Zanzibar.

* [Permify](https://github.com/Permify/permify) ⭐ 5,937 | 🐛 76 | 🌐 Go | 📅 2026-08-20 - 💸 Another open-source authorization as a service inspired by Google Zanzibar, and see [how it compares to other Zanzibar-inspired tools](https://permify.notion.site/Differentiation-Between-Zanzibar-Products-ad4732da62e64655bc82d3abe25f48b6).
...
* [Keycloak](https://github.com/keycloak/keycloak) ⭐ 36,325 | 🐛 3,111 | 🌐 Java | 📅 2026-08-21 - 🆓 Open-source Identity and Access Management. Supports OIDC, OAuth 2 and SAML 2, LDAP and AD directories, password policies.

* [authentik](https://github.com/goauthentik/authentik) ⭐ 25,051 | 🐛 1,057 | 🌐 Python | 📅 2026-08-21 - 💸 Open-source Identity Provider similar to Keycloak.

* [Hydra](https://github.com/ory/hydra) ⭐ 17,489 | 🐛 94 | 🌐 Go | 📅 2026-07-29 - 💸 Open-source OIDC & OAuth2 Server Provider.

* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,816 | 🐛 1,140 | 🌐 Go | 📅 2026-08-21 - 💸 An Open-Source solution built with Go and Angular to manage all your systems, users and service accounts together with their roles and external identities. ZITADEL provides you with OIDC, OAuth 2.0, login & register flows, passwordless and MFA authentication. All this is built on top of eventsourcing in combination with CQRS to provide a great audit trail.

* [Casdoor](https://github.com/casbin/casdoor) ⭐ 14,240 | 🐛 104 | 🌐 Go | 📅 2026-08-21 - 🆓 A UI-first centralized authentication / Single-Sign-On (SSO) platform based. Supports OIDC and OAuth 2, social logins, user management, 2FA based on Email and SMS.
...
* [HashiCorp Vault](https://github.com/hashicorp/vault) ⭐ 36,150 | 🐛 1,426 | 🌐 Go | 📅 2026-08-21 - 💸 Secure, store and tightly control access to tokens, passwords, certificates, encryption keys.

* [`gitleaks`](https://github.com/zricethezav/gitleaks) ⭐ 28,881 | 🐛 460 | 🌐 Go | 📅 2026-08-19 - 🆓 Audit Git repos for secrets.

* [Infisical](https://github.com/Infisical/infisical) ⭐ 28,869 | 🐛 742 | 🌐 TypeScript | 📅 2026-08-21 - 💸 An alternative to HashiCorp Vault.

* [`trufflehog`](https://github.com/trufflesecurity/trufflehog) ⭐ 27,538 | 🐛 518 | 🌐 Go | 📅 2026-08-20 - 💸 Searches through Git repositories for high entropy strings and secrets, digging deep into commit history.

* [`sops`](https://github.com/mozilla/sops) ⭐ 22,875 | 🐛 439 | 🌐 Go | 📅 2026-08-17 - 🆓 Editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, age, and PGP.
...
* [Project Oak](https://github.com/project-oak/oak) ⭐ 1,494 | 🐛 19 | 🌐 Rust | 📅 2026-08-20 - 🆓 A specification and a reference implementation for the secure transfer, storage and processing of data.

* [Keystone](https://github.com/keystone-enclave/keystone) ⭐ 535 | 🐛 118 | 🌐 C | 📅 2026-08-03 - 🆓 Open-source project for building trusted execution environments (TEE) with secure hardware enclaves, based on the RISC-V architecture.
...
* [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 89,916 | 🐛 334 | 🌐 Python | 📅 2026-08-21 - 🆓 Hunt down social media accounts by username across social networks.

* [Ballerine](https://github.com/ballerine-io/ballerine) ⭐ 2,424 | 🐛 9 | 🌐 TypeScript | 📅 2026-08-11 - 💸 An open-source infrastructure for user identity and risk management.
...
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,618 | 🐛 520 | 🌐 Java | 📅 2026-08-19 - 🆓 Open-source platform for visualizing and manipulating large graphs.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 72,969 | 🐛 12 | 🌐 PHP | 📅 2026-08-21 - 🆓 Collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.

* [Maigret](https://github.com/soxoj/maigret) ⭐ 36,931 | 🐛 20 | 🌐 Python | 📅 2026-08-21 - 🆓 “Collect a dossier on a person by username from 3000+ sites”, useful for account enumeration and unmasking fraud or abuse.

* [PhoneInfoga](https://github.com/sundowndev/PhoneInfoga) ⭐ 17,577 | 🐛 122 | 🌐 Go | 📅 2026-01-06 - 🆓 Tools to scan phone numbers using only free resources. The goal is to first gather standard information such as country, area, carrier and line type on any international phone numbers with a very good accuracy. Then search for footprints on search engines to try to find the VoIP provider or identify the owner.

* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,552 | 🐛 117 | 📅 2026-05-31 - “A concise definition of Threat Intelligence: evidence-based knowledge, including context, mechanisms, indicators, implications and actionable advice, about an existing or emerging menace or hazard to assets that can be used to inform decisions regarding the subject's response to that menace or hazard.”

* [OSINT Stuff Tool Collection](https://github.com/cipher387/osint_stuff_tool_collection) ⭐ 8,707 | 🐛 86 | 🌐 HTML | 📅 2026-05-12 - “A collection of several hundred online tools for OSINT”: domain, IP, email, username and social-network lookups useful for unmasking fraud and abuse.
...
* [Anubis](https://github.com/TecharoHQ/anubis) ⭐ 21,595 | 🐛 360 | 🌐 Go | 📅 2026-08-20 - 🆓 An open-source solution to protect upstream resources from scraper bots.
...
* [`hosts`](https://github.com/StevenBlack/hosts) ⭐ 30,922 | 🐛 150 | 🌐 Python | 📅 2026-08-20 - 🆓 Consolidates reputable hosts files, and merges them into a unified hosts file with duplicates removed.

* [The Public Suffix List](https://github.com/publicsuffix/list) ⭐ 2,916 | 🐛 85 | 🌐 Go | 📅 2026-08-19 - 🆓 Mozilla's registry of public suffixes, under which Internet users can (or historically could) directly register names.
...
* [Burner email providers](https://github.com/wesbos/burner-email-providers) ⭐ 1,189 | 🐛 22 | 🌐 JavaScript | 📅 2026-07-20 - 🆓 A list of temporary email providers. And its [derivative Python module](https://github.com/martenson/disposable-email-domains) ⭐ 5,433 | 🐛 36 | 🌐 Python | 📅 2026-08-21.
...
* [Paper we love: Privacy](https://github.com/papers-we-love/papers-we-love/tree/master/privacy) ⭐ 108,895 | 🐛 3 | 🌐 Shell | 📅 2026-07-01 - A collection of scientific studies of schemes providing privacy by design.
...
* [Presidio](https://github.com/microsoft/presidio) ⭐ 10,576 | 🐛 107 | 🌐 Python | 📅 2026-08-11 - 🆓 Context aware, pluggable and customizable data protection and PII data anonymization service for text and images.
...
* [Best-of Digital Identity](https://github.com/jruizaranguren/best-of-digital-identity) ⭐ 190 | 🐛 1 | 📅 2026-08-20 - Ranking, popularity and activity status of open-source digital identity projects.
