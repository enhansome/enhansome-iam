...
This curated [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 500,363 | 🐛 105 | 📅 2026-08-21 list expose all the technologies, protocols and jargon of the domain in a comprehensive and actionable manner.
...
* [Cartography](https://github.com/lyft/cartography) ⭐ 4,028 | 🐛 113 | 🌐 Python | 📅 2026-08-27 - 🆓 A Neo4J-based tool to map out dependencies and relationships between services and resources. Supports AWS, GCP, GSuite, Okta and GitHub.
...
* [Kratos](https://github.com/ory/kratos) ⭐ 13,850 | 🐛 222 | 🌐 Go | 📅 2026-07-29 - 💸 User login, user registration, 2FA and profile management.
...
* [Papers we love: Cryptography](https://github.com/papers-we-love/papers-we-love/blob/master/cryptography/README.md) ⭐ 109,031 | 🐛 3 | 🌐 Shell | 📅 2026-08-24 - Foundational papers of cryptography.
...
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,979 | 🐛 151 | 🌐 Go | 📅 2026-08-26 - 💸 An identity-aware proxy that enables secure access to internal applications.
...
* [heimdall](https://github.com/dadrus/heimdall) ⭐ 254 | 🐛 54 | 🌐 Go | 📅 2026-08-27 - 🆓 A cloud-native, identity-aware proxy and policy enforcement point that orchestrates authentication and authorization systems via versatile rules, supporting protocol-agnostic identity propagation.
...
* [SPIFFE/SPIRE](https://github.com/spiffe/spire) ⭐ 2,502 | 🐛 138 | 🌐 Go | 📅 2026-08-26 - 🆓 A CNCF framework issuing short-lived, cryptographically-verifiable identities (SVIDs) to workloads across heterogeneous environments.

* [NanoMDM](https://github.com/micromdm/nanomdm) ⭐ 637 | 🐛 16 | 🌐 Go | 📅 2026-08-27 - 🆓 Minimalist Apple MDM server and library to enroll and manage the identity of Apple devices, inspired by MicroMDM.
...
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,795 | 🐛 111 | 🌐 JavaScript | 📅 2026-08-26 - 🆓 A collection of password rules, change URLs and quirks by sites.
...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,718 | 🐛 129 | 🌐 Go | 📅 2026-08-27 - 🆓 Open-source authentication and authorization server providing two-factor authentication and single sign-on (SSO) for your applications via a web portal.

* [Kanidm](https://github.com/kanidm/kanidm) ⭐ 5,292 | 🐛 265 | 🌐 Rust | 📅 2026-08-26 - 🆓 Simple, secure and fast identity management platform.
...
* [OpenSK](https://github.com/google/OpenSK) ⭐ 3,404 | 🐛 12 | 🌐 Rust | 📅 2026-08-06 - 🆓 Open-source implementation for security keys written in Rust that supports both FIDO U2F and FIDO2 standards.
...
* [CFSSL](https://github.com/cloudflare/cfssl) ⭐ 9,462 | 🐛 337 | 🌐 Go | 📅 2026-04-24 - 🆓 A swiss army knife for PKI/TLS by CloudFlare. Command line tool and an HTTP API server for signing, verifying, and bundling TLS certificates.

* [JA4+](https://github.com/FoxIO-LLC/ja4) ⭐ 2,061 | 🐛 25 | 🌐 Rust | 📅 2026-08-27 - 💸 A suite of network fingerprinting methods to facilitate threat-hunting and analysis.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,558 | 🐛 59 | 🌐 Go | 📅 2026-08-27 - 💸 An authorization endpoint to write context-aware access control policies.

* [Athenz](https://github.com/yahoo/athenz) ⭐ 1,005 | 🐛 51 | 🌐 Java | 📅 2026-08-27 - 🆓 Set of services and libraries supporting service authentication and role-based authorization for provisioning and configuration.

* [FerrisKey](https://github.com/ferriskey/ferriskey) ⭐ 687 | 🐛 86 | 🌐 Rust | 📅 2026-08-27 - 🆓 Self-hosted, open-source, RBAC system written in Rust.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,353 | 🐛 38 | 🌐 Go | 📅 2026-08-21 - 🆓 Open-source access control library for Golang projects.

* [Open Policy Agent](https://github.com/open-policy-agent/opa) ⭐ 12,171 | 🐛 342 | 🌐 Go | 📅 2026-08-27 - 🆓 An open-source general-purpose decision engine to create and enforce ABAC policies.

* [Keto](https://github.com/ory/keto) ⭐ 5,391 | 🐛 73 | 🌐 Go | 📅 2026-08-24 - 💸 Policy decision point. It uses a set of access control policies, similar to AWS policies, in order to determine whether a subject is authorized to perform a certain action on a resource.
...
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 6,990 | 🐛 149 | 🌐 Go | 📅 2026-08-26 - 💸 An open source database system for managing security-critical application permissions inspired by Zanzibar.

* [Permify](https://github.com/Permify/permify) ⭐ 5,941 | 🐛 78 | 🌐 Go | 📅 2026-08-27 - 💸 Another open-source authorization as a service inspired by Google Zanzibar, and see [how it compares to other Zanzibar-inspired tools](https://permify.notion.site/Differentiation-Between-Zanzibar-Products-ad4732da62e64655bc82d3abe25f48b6).
...
* [Keycloak](https://github.com/keycloak/keycloak) ⭐ 36,444 | 🐛 3,134 | 🌐 Java | 📅 2026-08-27 - 🆓 Open-source Identity and Access Management. Supports OIDC, OAuth 2 and SAML 2, LDAP and AD directories, password policies.

* [authentik](https://github.com/goauthentik/authentik) ⭐ 25,186 | 🐛 1,071 | 🌐 Python | 📅 2026-08-27 - 💸 Open-source Identity Provider similar to Keycloak.

* [Hydra](https://github.com/ory/hydra) ⭐ 17,502 | 🐛 94 | 🌐 Go | 📅 2026-07-29 - 💸 Open-source OIDC & OAuth2 Server Provider.

* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,872 | 🐛 1,136 | 🌐 Go | 📅 2026-08-27 - 💸 An Open-Source solution built with Go and Angular to manage all your systems, users and service accounts together with their roles and external identities. ZITADEL provides you with OIDC, OAuth 2.0, login & register flows, passwordless and MFA authentication. All this is built on top of eventsourcing in combination with CQRS to provide a great audit trail.

* [Casdoor](https://github.com/casbin/casdoor) ⭐ 14,281 | 🐛 112 | 🌐 Go | 📅 2026-08-25 - 🆓 A UI-first centralized authentication / Single-Sign-On (SSO) platform based. Supports OIDC and OAuth 2, social logins, user management, 2FA based on Email and SMS.
...
* [HashiCorp Vault](https://github.com/hashicorp/vault) ⭐ 36,178 | 🐛 1,431 | 🌐 Go | 📅 2026-08-26 - 💸 Secure, store and tightly control access to tokens, passwords, certificates, encryption keys.

* [Infisical](https://github.com/Infisical/infisical) ⭐ 28,987 | 🐛 744 | 🌐 TypeScript | 📅 2026-08-27 - 💸 An alternative to HashiCorp Vault.

* [`gitleaks`](https://github.com/zricethezav/gitleaks) ⭐ 28,971 | 🐛 466 | 🌐 Go | 📅 2026-08-26 - 🆓 Audit Git repos for secrets.

* [`trufflehog`](https://github.com/trufflesecurity/trufflehog) ⭐ 27,602 | 🐛 524 | 🌐 Go | 📅 2026-08-26 - 💸 Searches through Git repositories for high entropy strings and secrets, digging deep into commit history.

* [`sops`](https://github.com/mozilla/sops) ⭐ 22,936 | 🐛 443 | 🌐 Go | 📅 2026-08-26 - 🆓 Editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, age, and PGP.
...
* [Project Oak](https://github.com/project-oak/oak) ⭐ 1,497 | 🐛 17 | 🌐 Rust | 📅 2026-08-26 - 🆓 A specification and a reference implementation for the secure transfer, storage and processing of data.
...
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,623 | 🐛 453 | 🌐 Java | 📅 2026-08-27 - 🆓 Open-source platform for visualizing and manipulating large graphs.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,120 | 🐛 13 | 🌐 PHP | 📅 2026-08-26 - 🆓 Collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.

* [Maigret](https://github.com/soxoj/maigret) ⭐ 37,089 | 🐛 24 | 🌐 Python | 📅 2026-08-27 - 🆓 “Collect a dossier on a person by username from 3000+ sites”, useful for account enumeration and unmasking fraud or abuse.

* [PhoneInfoga](https://github.com/sundowndev/PhoneInfoga) ⭐ 17,652 | 🐛 123 | 🌐 Go | 📅 2026-08-25 - 🆓 Tools to scan phone numbers using only free resources. The goal is to first gather standard information such as country, area, carrier and line type on any international phone numbers with a very good accuracy. Then search for footprints on search engines to try to find the VoIP provider or identify the owner.

* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,580 | 🐛 116 | 📅 2026-05-31 - “A concise definition of Threat Intelligence: evidence-based knowledge, including context, mechanisms, indicators, implications and actionable advice, about an existing or emerging menace or hazard to assets that can be used to inform decisions regarding the subject's response to that menace or hazard.”

* [OSINT Stuff Tool Collection](https://github.com/cipher387/osint_stuff_tool_collection) ⭐ 8,738 | 🐛 87 | 🌐 HTML | 📅 2026-05-12 - “A collection of several hundred online tools for OSINT”: domain, IP, email, username and social-network lookups useful for unmasking fraud and abuse.
...
* [Anubis](https://github.com/TecharoHQ/anubis) ⭐ 21,760 | 🐛 364 | 🌐 Go | 📅 2026-08-25 - 🆓 An open-source solution to protect upstream resources from scraper bots.
...
* [`hosts`](https://github.com/StevenBlack/hosts) ⭐ 30,959 | 🐛 153 | 🌐 Python | 📅 2026-08-26 - 🆓 Consolidates reputable hosts files, and merges them into a unified hosts file with duplicates removed.

* [The Public Suffix List](https://github.com/publicsuffix/list) ⭐ 2,921 | 🐛 70 | 🌐 Go | 📅 2026-08-19 - 🆓 Mozilla's registry of public suffixes, under which Internet users can (or historically could) directly register names.
...
* [MailChecker](https://github.com/FGRibreau/mailchecker) ⭐ 1,905 | 🐛 5 | 🌐 PHP | 📅 2026-08-26 - 💸 Cross-language temporary (disposable/throwaway) email detection library.

* [Burner email providers](https://github.com/wesbos/burner-email-providers) ⭐ 1,189 | 🐛 24 | 🌐 JavaScript | 📅 2026-07-20 - 🆓 A list of temporary email providers. And its [derivative Python module](https://github.com/martenson/disposable-email-domains) ⭐ 5,454 | 🐛 36 | 🌐 Python | 📅 2026-08-27.
...
* [List of Dirty, Naughty, Obscene, and Otherwise Bad Words](https://github.com/LDNOOBW/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words) ⭐ 3,432 | 🐛 105 | 📅 2024-08-05 - 🆓 Profanity blocklist from Shutterstock.
...
* [Paper we love: Privacy](https://github.com/papers-we-love/papers-we-love/tree/master/privacy) ⭐ 109,031 | 🐛 3 | 🌐 Shell | 📅 2026-08-24 - A collection of scientific studies of schemes providing privacy by design.
...
* [Presidio](https://github.com/microsoft/presidio) ⭐ 10,651 | 🐛 106 | 🌐 Python | 📅 2026-08-26 - 🆓 Context aware, pluggable and customizable data protection and PII data anonymization service for text and images.
