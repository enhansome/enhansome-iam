...
[IAM](https://en.wikipedia.org/wiki/Identity_management) stands for Identity and Access Management. It is a complex domain which covers **user accounts, authentication, authorization, roles, permissions and privacy**. It is an essential pillar of the cloud stack, where users, products and security meets. The [other pillar being billing & payments 💰](https://github.com/kdeldycke/awesome-billing/) ⭐ 1,336 | 🐛 3 | 📅 2026-08-14.

This curated [![Awesome](https://awesome.re/badge-flat.svg)](https://github.com/sindresorhus/awesome) ⭐ 503,216 | 🐛 106 | 📅 2026-09-02 list expose all the technologies, protocols and jargon of the domain in a comprehensive and actionable manner.
...
* [Cartography](https://github.com/lyft/cartography) ⭐ 4,039 | 🐛 118 | 🌐 Python | 📅 2026-09-05 - 🆓 A Neo4J-based tool to map out dependencies and relationships between services and resources. Supports AWS, GCP, GSuite, Okta and GitHub.
...
* [Kratos](https://github.com/ory/kratos) ⭐ 13,867 | 🐛 222 | 🌐 Go | 📅 2026-07-29 - 💸 User login, user registration, 2FA and profile management.
...
* [Papers we love: Cryptography](https://github.com/papers-we-love/papers-we-love/blob/master/cryptography/README.md) ⭐ 109,468 | 🐛 4 | 🌐 Shell | 📅 2026-08-31 - Foundational papers of cryptography.
...
* [Pomerium](https://github.com/pomerium/pomerium) ⭐ 4,994 | 🐛 151 | 🌐 Go | 📅 2026-09-05 - 💸 An identity-aware proxy that enables secure access to internal applications.
...
* [SPIFFE/SPIRE](https://github.com/spiffe/spire) ⭐ 2,517 | 🐛 126 | 🌐 Go | 📅 2026-09-05 - 🆓 A CNCF framework issuing short-lived, cryptographically-verifiable identities (SVIDs) to workloads across heterogeneous environments.

* [NanoMDM](https://github.com/micromdm/nanomdm) ⭐ 642 | 🐛 18 | 🌐 Go | 📅 2026-09-03 - 🆓 Minimalist Apple MDM server and library to enroll and manage the identity of Apple devices, inspired by MicroMDM.
...
* [Password Manager Resources](https://github.com/apple/password-manager-resources) ⭐ 4,814 | 🐛 117 | 🌐 JavaScript | 📅 2026-09-04 - 🆓 A collection of password rules, change URLs and quirks by sites.
...
* [Authelia](https://github.com/authelia/authelia) ⭐ 28,803 | 🐛 130 | 🌐 Go | 📅 2026-09-05 - 🆓 Open-source authentication and authorization server providing two-factor authentication and single sign-on (SSO) for your applications via a web portal.

* [Kanidm](https://github.com/kanidm/kanidm) ⭐ 5,339 | 🐛 271 | 🌐 Rust | 📅 2026-09-04 - 🆓 Simple, secure and fast identity management platform.
...
* [YubiKey Guide](https://github.com/drduh/YubiKey-Guide) ⭐ 12,456 | 🐛 11 | 🌐 HTML | 📅 2026-08-23 - Guide to using YubiKey as a SmartCard for storing GPG encryption, signing and authentication keys, which can also be used for SSH. Many of the principles in this document are applicable to other smart card devices.

* [OpenSK](https://github.com/google/OpenSK) ⭐ 3,417 | 🐛 12 | 🌐 Rust | 📅 2026-09-04 - 🆓 Open-source implementation for security keys written in Rust that supports both FIDO U2F and FIDO2 standards.
...
* [JA4+](https://github.com/FoxIO-LLC/ja4) ⭐ 2,075 | 🐛 21 | 🌐 Rust | 📅 2026-09-03 - 💸 A suite of network fingerprinting methods to facilitate threat-hunting and analysis.
...
* [Cerbos](https://github.com/cerbos/cerbos) ⭐ 4,575 | 🐛 57 | 🌐 Go | 📅 2026-09-03 - 💸 An authorization endpoint to write context-aware access control policies.
...
* [FerrisKey](https://github.com/ferriskey/ferriskey) ⭐ 694 | 🐛 89 | 🌐 Rust | 📅 2026-09-03 - 🆓 Self-hosted, open-source, RBAC system written in Rust.
...
* [Casbin](https://github.com/casbin/casbin) ⭐ 20,372 | 🐛 45 | 🌐 Go | 📅 2026-08-21 - 🆓 Open-source access control library for Golang projects.

* [Open Policy Agent](https://github.com/open-policy-agent/opa) ⭐ 12,199 | 🐛 333 | 🌐 Go | 📅 2026-09-05 - 🆓 An open-source general-purpose decision engine to create and enforce ABAC policies.

* [Keto](https://github.com/ory/keto) ⭐ 5,394 | 🐛 74 | 🌐 Go | 📅 2026-09-04 - 💸 Policy decision point. It uses a set of access control policies, similar to AWS policies, in order to determine whether a subject is authorized to perform a certain action on a resource.
...
* [SpiceDB](https://github.com/authzed/spicedb) ⭐ 7,025 | 🐛 144 | 🌐 Go | 📅 2026-09-04 - 💸 An open source database system for managing security-critical application permissions inspired by Zanzibar.

* [Permify](https://github.com/Permify/permify) ⭐ 5,947 | 🐛 118 | 🌐 Go | 📅 2026-09-03 - 💸 Another open-source authorization as a service inspired by Google Zanzibar, and see [how it compares to other Zanzibar-inspired tools](https://permify.notion.site/Differentiation-Between-Zanzibar-Products-ad4732da62e64655bc82d3abe25f48b6).

* [Open Policy Administration Layer](https://github.com/permitio/opal) ⭐ 5,503 | 🐛 64 | 🌐 Python | 📅 2026-09-03 - 💸 Open Source administration layer for OPA, detecting changes to both policy and policy data in realtime and pushing live updates to OPA agents. OPAL brings open-policy up to the speed needed by live applications.
...
* [Keycloak](https://github.com/keycloak/keycloak) ⭐ 36,614 | 🐛 3,239 | 🌐 Java | 📅 2026-09-05 - 🆓 Open-source Identity and Access Management. Supports OIDC, OAuth 2 and SAML 2, LDAP and AD directories, password policies.

* [authentik](https://github.com/goauthentik/authentik) ⭐ 25,372 | 🐛 1,092 | 🌐 Python | 📅 2026-09-05 - 💸 Open-source Identity Provider similar to Keycloak.

* [Hydra](https://github.com/ory/hydra) ⭐ 17,521 | 🐛 96 | 🌐 Go | 📅 2026-07-29 - 💸 Open-source OIDC & OAuth2 Server Provider.

* [ZITADEL](https://github.com/zitadel/zitadel) ⭐ 14,947 | 🐛 1,156 | 🌐 Go | 📅 2026-09-04 - 💸 An Open-Source solution built with Go and Angular to manage all your systems, users and service accounts together with their roles and external identities. ZITADEL provides you with OIDC, OAuth 2.0, login & register flows, passwordless and MFA authentication. All this is built on top of eventsourcing in combination with CQRS to provide a great audit trail.

* [Casdoor](https://github.com/casbin/casdoor) ⭐ 14,346 | 🐛 96 | 🌐 Go | 📅 2026-09-05 - 🆓 A UI-first centralized authentication / Single-Sign-On (SSO) platform based. Supports OIDC and OAuth 2, social logins, user management, 2FA based on Email and SMS.
...
* [HashiCorp Vault](https://github.com/hashicorp/vault) ⭐ 36,209 | 🐛 1,432 | 🌐 Go | 📅 2026-09-04 - 💸 Secure, store and tightly control access to tokens, passwords, certificates, encryption keys.

* [Infisical](https://github.com/Infisical/infisical) ⭐ 29,132 | 🐛 779 | 🌐 TypeScript | 📅 2026-09-05 - 💸 An alternative to HashiCorp Vault.

* [`gitleaks`](https://github.com/zricethezav/gitleaks) ⭐ 29,112 | 🐛 474 | 🌐 Go | 📅 2026-08-26 - 🆓 Audit Git repos for secrets.

* [`trufflehog`](https://github.com/trufflesecurity/trufflehog) ⭐ 27,692 | 🐛 539 | 🌐 Go | 📅 2026-09-05 - 💸 Searches through Git repositories for high entropy strings and secrets, digging deep into commit history.

* [`sops`](https://github.com/mozilla/sops) ⭐ 23,028 | 🐛 443 | 🌐 Go | 📅 2026-09-02 - 🆓 Editor of encrypted files that supports YAML, JSON, ENV, INI and BINARY formats and encrypts with AWS KMS, GCP KMS, Azure Key Vault, age, and PGP.
...
* [Awesome List of Billing and Payments: Fraud links](https://github.com/kdeldycke/awesome-billing#fraud) ⭐ 1,336 | 🐛 3 | 📅 2026-08-14 - Section dedicated to fraud management for billing and payment, from our sister repository.
...
* [Sherlock](https://github.com/sherlock-project/sherlock) ⭐ 90,969 | 🐛 340 | 🌐 Python | 📅 2026-09-05 - 🆓 Hunt down social media accounts by username across social networks.
...
* [Gephi](https://github.com/gephi/gephi) ⭐ 6,629 | 🐛 441 | 🌐 Java | 📅 2026-09-05 - 🆓 Open-source platform for visualizing and manipulating large graphs.
...
* [SecLists](https://github.com/danielmiessler/SecLists) ⭐ 73,293 | 🐛 13 | 🌐 PHP | 📅 2026-09-05 - 🆓 Collection of multiple types of lists used during security assessments, collected in one place. List types include usernames, passwords, URLs, sensitive data patterns, fuzzing payloads, web shells, and many more.

* [Maigret](https://github.com/soxoj/maigret) ⭐ 37,311 | 🐛 25 | 🌐 Python | 📅 2026-09-05 - 🆓 “Collect a dossier on a person by username from 3000+ sites”, useful for account enumeration and unmasking fraud or abuse.

* [PhoneInfoga](https://github.com/sundowndev/PhoneInfoga) ⭐ 17,782 | 🐛 136 | 🌐 Go | 📅 2026-08-25 - 🆓 Tools to scan phone numbers using only free resources. The goal is to first gather standard information such as country, area, carrier and line type on any international phone numbers with a very good accuracy. Then search for footprints on search engines to try to find the VoIP provider or identify the owner.

* [Awesome Threat Intelligence](https://github.com/hslatman/awesome-threat-intelligence) ⭐ 10,604 | 🐛 121 | 📅 2026-05-31 - “A concise definition of Threat Intelligence: evidence-based knowledge, including context, mechanisms, indicators, implications and actionable advice, about an existing or emerging menace or hazard to assets that can be used to inform decisions regarding the subject's response to that menace or hazard.”

* [OSINT Stuff Tool Collection](https://github.com/cipher387/osint_stuff_tool_collection) ⭐ 8,783 | 🐛 93 | 🌐 HTML | 📅 2026-05-12 - “A collection of several hundred online tools for OSINT”: domain, IP, email, username and social-network lookups useful for unmasking fraud and abuse.
...
* [Anubis](https://github.com/TecharoHQ/anubis) ⭐ 22,148 | 🐛 370 | 🌐 Go | 📅 2026-08-31 - 🆓 An open-source solution to protect upstream resources from scraper bots.
...
* [`hosts`](https://github.com/StevenBlack/hosts) ⭐ 30,999 | 🐛 155 | 🌐 Python | 📅 2026-09-04 - 🆓 Consolidates reputable hosts files, and merges them into a unified hosts file with duplicates removed.

* [The Public Suffix List](https://github.com/publicsuffix/list) ⭐ 2,933 | 🐛 58 | 🌐 Go | 📅 2026-09-05 - 🆓 Mozilla's registry of public suffixes, under which Internet users can (or historically could) directly register names.
...
* [`check-if-email-exists`](https://github.com/reacherhq/check-if-email-exists) ⭐ 9,553 | 🐛 88 | 🌐 Rust | 📅 2026-03-17 - 💸 Verify an email address's reachability over SMTP without sending anything, catching typos, disposable domains and role accounts at signup.
...
* [Burner email providers](https://github.com/wesbos/burner-email-providers) ⭐ 1,189 | 🐛 25 | 🌐 JavaScript | 📅 2026-07-20 - 🆓 A list of temporary email providers. And its [derivative Python module](https://github.com/martenson/disposable-email-domains) ⭐ 5,475 | 🐛 42 | 🌐 Python | 📅 2026-09-05.

* [`gman`](https://github.com/benbalter/gman) ⭐ 171 | 🐛 12 | 🌐 Ruby | 📅 2026-09-05 - 🆓 “A Ruby gem to check if the owner of a given email address or website is working for THE MAN (a.k.a verifies government domains).” Good resource to hunt for potential government customers in your user base.
...
* [List of Dirty, Naughty, Obscene, and Otherwise Bad Words](https://github.com/LDNOOBW/List-of-Dirty-Naughty-Obscene-and-Otherwise-Bad-Words) ⭐ 3,439 | 🐛 105 | 📅 2024-08-05 - 🆓 Profanity blocklist from Shutterstock.
...
* [Paper we love: Privacy](https://github.com/papers-we-love/papers-we-love/tree/master/privacy) ⭐ 109,468 | 🐛 4 | 🌐 Shell | 📅 2026-08-31 - A collection of scientific studies of schemes providing privacy by design.
...
* [Presidio](https://github.com/microsoft/presidio) ⭐ 10,748 | 🐛 108 | 🌐 Python | 📅 2026-08-31 - 🆓 Context aware, pluggable and customizable data protection and PII data anonymization service for text and images.
